...
CREATE TABLE tnra.railwayarea (
    ...
    geographicalname_pronunciationofname_ipa text,
    geographicalname_pronunciationofname_ipa_nilreason text,
    geographicalname_pronunciationofname_ipa_nil boolean,
